...
">
                    ...
                    <div class="hero-content">
                        ...
                        <a href="#portfolio" class="slide-down-btn" aria-label="scroll down">
                            <ion-icon name="arrow-down" aria-hidden="true" role="img" class="md hydrated"></ion-icon>
                        </a>
                        <div class="flex-col">
                            <h5>Contact Details</h5>
                            <ul class="links-wrap">
                                <li class="btn btn-link btn-link-external">
                                    <a href="mailto:ammar132004@gmail.com" class="btn-click magnetic external-link "
                                        data-strength="20" data-strength-text="10">
                                        <span class="btn-text">
                                            <span class="btn-text-inner">ammar132004@gmail.com</span>
                                        </span>
                                    </a>
                                </li>
                                <li class="btn btn-link btn-link-external">
                                    <a href="tel:+201070479599" class="btn-click magnetic external-link "
                                        data-strength="20" data-strength-text="10">
                                        <span class="btn-text">
                                            <span class="btn-text-inner">+201070479599</span>
                                        </span>
                                    </a>
                                </li>
                            </ul>
                            ...
                            <ul class="links-wrap">
                                <li class="btn btn-link btn-link-external">
                                    <a href="https://www.facebook.com/profile.php?id=100024713541158" target="_blank"
                                        class="btn-click magnetic external-link " data-strength="20"
                                        data-strength-text="10">
                                        <span class="btn-text">
                                            <span class="btn-text-inner">face book</span>
                                        </span>
                                    </a>
                                </li>
                                <li class="btn btn-link btn-link-external">
                                ...
                                <li class="btn btn-link btn-link-external">
                                    <a href="https://twitter.com/Ammar132004" target="_blank"
                                        class="btn-click magnetic external-link " data-strength="20"
                                        data-strength-text="10">
                                        <span class="btn-text">
                    ...
                    <header class="section default-header contact-header theme-dark" data-scroll-section>
                        ...
                        <div class="container medium">
                            ...
                            <div class="row once-in">
                                <div class="flex-col">
                                    <form class="form" method="post" action="../pages/Contact.html"
                                        ...
                                        <div class="form-col">
                                            ...
                                            <input class="field" type="email" id="form-email" name="email" value="" required
                                                placeholder="ammar132004@gmail.com *">
                                        </div>
                                        <!-- <div class="form-col">
                  <h5>03</h5>
                  ...
                  <input class="field" type="text" id="form-company" name="company" value="" required placeholder="John & Doe ®">
                                        ...
                                        <div class="form-col">
                                            ...
                                            <input class="field" type="tel" id="form-service" name="service" value="" required
                                                placeholder="+201070479599">
                                        </div>
                                        <div class="form-col">
                                            <h5>04</h5>
                                            <label class="label" for="message">Your message</label>
                                            <textarea class="field" type="text" id="form-message" name="message" rows="8"
                                                required placeholder="Hello Ammar, can you help me with ... *"></textarea>
                                        </div>
    ...
    <style>
        ...
        .contact-header .row:nth-child(1) .flex-col:nth-child(2) {
            padding-top: calc(clamp(3.25em, 7vw, 8em) * 0.875 * 1.175);
        }
        ...
        @media screen and (max-width: 720px) {
            ...
            .contact-header .row:nth-child(1) .flex-col:nth-child(2) {
                height: calc(var(--section-padding) * 0.75);
            }
        ...
        .error-header .stripe {
            margin-top: calc(var(--section-padding) * 0.66);
        }
    ...
    <style>
        ...
        li.btn.btn-link.btn-link-external a {
            padding: 0 !important;
            margin: 0 !important;
            line-height: 2;
            margin-bottom: 2vh !important;
        ...
        a.btn-click.magnetic.external-link {
            color: black;
        }
