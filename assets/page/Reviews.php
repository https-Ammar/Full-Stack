                ...
                <div class="container ">
                    ...
                    <div class="d-flex">
                        <div class="sidebar">
                            ...
                            <button class="icon-button"><svg class="_svg " xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 448 512">
                                    <path
                        ...
                        <div class="block_">
                            <div class="sidebar">
                                <button class="icon-button"><svg class="_svg primary-fill"
                            ...
                            <div class="main-content" id="audio-cards-container"></div>

                            <audio id="hidden-player"></audio>

                            <footer class="footer">
                                <div>
                                    <small class="muted Copyright">Copyright @ Ammar_Ahmed 2024 • </small>
                                </div>
                            </footer>
                        </div>
