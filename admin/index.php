            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] mb-6">
                ...
                <div
                    ...
                    <div class="border-b border-gray-200 px-6 py-5 sm:border-r xl:border-b-0 dark:border-gray-800">
                        ...
                        <div class="mt-2 flex items-end gap-3">
                            <h4 class="text-title-xs sm:text-title-sm font-bold text-gray-800 dark:text-white/90">
                                <?= htmlspecialchars($totalVisitors) ?>
                            </h4>
                            <div>
                                <span
                    ...
                    <div class="border-b border-gray-200 px-6 py-5 xl:border-r xl:border-b-0 dark:border-gray-800">
                        ...
                        <div class="mt-2 flex items-end gap-3">
                            <h4 class="text-title-xs sm:text-title-sm font-bold text-gray-800 dark:text-white/90">
                                <?= htmlspecialchars($totalProjects) ?>
                            </h4>
                            <div>
                                <span
                                    class="bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500 flex items-center gap-1 rounded-full py-0.5 pr-2.5 pl-2 text-sm font-medium">
                    ...
                    <div class="border-b border-gray-200 px-6 py-5 sm:border-r sm:border-b-0 dark:border-gray-800">
                        <div>
                            <span class="text-sm text-gray-500 dark:text-gray-400">Project Views

                            </span>
                            <div class="mt-2 flex items-end gap-3">
                                <h4 class="text-title-xs sm:text-title-sm font-bold text-gray-800 dark:text-white/90">
                                    <?= htmlspecialchars($totalProjectViews) ?>
                                </h4>
                                <div>
                                    <span
                    ...
                    <div class="px-6 py-5">
                        <span class="text-sm text-gray-500 dark:text-gray-400">day now</span>
                        <div class="mt-2 flex items-end gap-3">
                            <h4 class="text-title-xs sm:text-title-sm font-bold text-gray-800 dark:text-white/90">
                                <?php
                                echo date('j');
                        ...
                        <table class="min-w-full">
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                ...
                                if ($res && $res->num_rows > 0) {
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <span
                                                                ...
                                                                <?= htmlspecialchars($row['country'] ?? 'Unknown') ?>
                                                            </span>
                                            ...
                                            <td class="px-6 py-3 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <p class="text-gray-700 text-theme-sm dark:text-gray-400">
                                                        IP - <?= htmlspecialchars($row['ip_address'] ?? 'Unknown') ?>
                                                    </p>
                                                </div>
                                            </td>
                                            <td class="px-6 py-3 whitespace-nowrap">
                                    ...
                                    echo '<tr><td colspan="7" class="px-6 py-3 whitespace-nowrap text-center text-gray-500">No visitors yet</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
