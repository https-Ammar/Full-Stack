            ...
            <div class="container medium">
                <div class="row">
                    <div class="flex-col">
                        ...
                        <h2><span>
                                <div class="profile-picture"></div> Let’s work
                            </span><span>together</span></h2>
                    </div>
                </div>
                <div class="row">
                    <div class="flex-col">
                        ...
                        <div class="btn-fixed">
                            <div class="btn btn-round" data-scroll data-scroll-speed="-1"
                                ...
                                <a href="./Contact.php" class="btn-click magnetic" data-strength="100"
                ...
                <div class="row">
                    <div class="flex-col">
                        <div class="btn btn-normal">
                            <a href="mailto:ammar@eng-ammar.com" class="btn-click magnetic" data-strength="25"
                                data-strength-text="15">
                                <div class="btn-fill"></div>
                                <span class="btn-text"><span
                                        class="btn-text-inner change">ammar@eng-ammar.com</span></span>
                            </a>
                        </div>
                        <div class="btn btn-normal">
                            <a href="tel:+201070479599" class="btn-click magnetic" data-strength="25"
                                data-strength-text="15">
                                <div class="btn-fill"></div>
                                <span class="btn-text"><span class="btn-text-inner change">+201070479599</span></span>
                            </a>
                        </div>
                    </div>
                </div>
                                ...
                                <ul>
                                    <li class="btn btn-link btn-link-external">
                                        <a href="https://www.facebook.com/eng.amaar.ah.med/" target="_blank"
                                            rel="noopener noreferrer" class="btn-click magnetic" data-strength="20"
                                    ...
                                    <li class="btn btn-link btn-link-external">
                                        <a href="https://wa.me/+201065424756" target="_blank" rel="noopener noreferrer"
